...
class Person:
    def __init__(self):
        ...
        self.job = ["Диетолог", "Психолог", "Сексолог", "Строитель", "Учитель", "Военний", "Пилот", "Художник",
                    ...
                    "Кондитер", "Хирург", "Инжирен", "Инструктор по выживанию", "Бухгалтер", "Ландшафтный дизайнер",
                    ...
                    "SMM менеджер", "Касир", "Електрик", "Сантехник", "Кибер-спортсмен", "Оператор набора теста",
        ...
        self.hobby = ["Животноводство", "Парусний спорт", "Рибалка", "Бадминон", "Кепминг", "Футбол",
                      "Реставрация поверхностей", "Готовка", "Фермерство", "Астрономия", "Радиосвязь", "Оригами", "Стенд ап", "Химия"
                      ...
                      "на аукционах", "Просмотр Сериалов", "Ремонт машин", "Битбокс", "Таксидермия(Производство чучел"
                      " животных)", "Вьязание", "Плаванье", "Готовка мьяса", "Езда на скейте", "Рисование на теле",
        ...
        self.item = ["Сборник 100 лутшых фильмов", "Удочка и снасти для рыбалки", "Инкубатор и набор яиц для выращивания"
                     ...
                     "Красный диплом", "Зарядные устройства всех типов", "Набор масок и распираторов", "Полные пакеты еды",
        ...
        self.dopInfo = ["Знал президента", "Переспал(ла) с порнозвездой", "Проходил курси психолога",
                        ...
                        " языков", "Чемпион мира по 100 клеточным шашкам", "Бросал курить 12 раз", "Роботаю с 14 лет",
                        "Служил в мор. флоте", "Вегатерианец", "Нацыоналист", "Побывал во всех странах", "Получил "
                        "льотною лицензию", "Мой лутший друг Бил Гейтс", "Знаю язык жестов", "Знаю все тренды тиктока",
                        "Путаю лево,право,верх и низ", ""]

        self.humanTrait = ["Параноик", "Зануда", "Конфликтный", "Настойчивый", "Жизнерадосний", "Скучний", "Понимающий",
                           "ЧСВ", "Чудесен", "Нимфоманка", "Пацифист", "Интроверт", "Екстраверт", "Невротик", "Доверчивый"
